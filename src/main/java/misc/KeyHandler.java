...
/**
 * The misc.KeyHandler class handles keyboard input from the user,
...
public class KeyHandler implements KeyListener {
    ...
    /** The misc.GamePanel associated with this misc.KeyHandler. */
    GamePanel gamePanel;

    /**
     * Constructs a misc.KeyHandler with the specified misc.GamePanel.
     *
     * @param gamePanel the misc.GamePanel to associate with this misc.KeyHandler
     */
