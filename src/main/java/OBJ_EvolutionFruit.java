...
/**
 * The OBJ_EvolutionFruit class represents an interactable object in the game
...
public class OBJ_EvolutionFruit extends SuperObject {
    ...
    /**
     * Constructs an OBJ_EvolutionFruit instance, sets its name, loads its sprite image,
