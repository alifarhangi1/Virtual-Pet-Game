...
/**
 * The TileManager class is responsible for managing and rendering tiles in the game world.
...
public class TileManager {
    ...
    /**
     * Constructs a TileManager instance and initializes the tile data and map.
     *
     * @param gamePanel the GamePanel instance associated with the TileManager
