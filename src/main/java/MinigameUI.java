...
/**
 * The MinigameUI class is responsible for rendering the user interface (UI)
 * for the game, including dialogue windows, level-specific graphics, and
 * victory screens.
 */
public class MinigameUI {

    /** The GamePanel instance associated with this UI. */
    GamePanel gamePanel;
    ...
    /**
     * Constructs a MinigameUI instance and initializes resources such as fonts
     * and images.
     *
     * @param gamePanel the GamePanel instance associated with this UI
     */
